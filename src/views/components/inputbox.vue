...
<template>
    <div :class="classes">
        ...
        <div :class="[prefixCls + '-content']" v-if="plain==false" :style="contentStyles">
            <Tooltip :content="validateMessage" :placement="placement" :disabled="validateMessage? false:true">
                <slot></slot>
            </Tooltip>
        </div>
        <div :class="[prefixCls + '-content']" v-else>
            <slot></slot>
        </div>
    </div>
</template>
...
export default {
  ...
  methods: {
    ...
    validate(trigger, callback = function() {}) {
      ...
      validator.validate(
        model,
        { firstFields: true, model: this.form.model },
        errors => {
