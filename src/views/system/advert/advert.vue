<template>
    <div class="advert">
                ...
                <Form :model="data" inline :label-width="80">
                    <FormItem label="类型">
                        <Select v-model="data.pid" style="width:300px;" @on-change="pidChanged">
                            <Option value="5a6e0200189ce82880da79a4">货主端首页轮播</Option>
                            <Option value="5d08572ea7b96c3f92e9529f">司机端首页轮播</Option>
                        </Select>
                    </FormItem>
                </Form>
            </Col>
        ...
        <div class="carousel">
            <Carousel autoplay v-model="index" loop>
                <CarouselItem v-for="item in adverts" :key="item.id"> 
                    <img class="image" :src="item.url" :alt="item.filename">
                </CarouselItem>
            </Carousel>
        </div>
